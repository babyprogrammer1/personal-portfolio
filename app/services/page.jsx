...
const Services = () => {
  return (
    ...
    >
      <div className="container mx-auto w-full flex flex-col gap-16 xl:mt-[80px] sm:mt-[120px] md:mt-[80px]">
        {/* text */}
        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center
        gap-8">
          {/* headline */}
          <h2 className="h2 max-w-[480] text-left xl:mb-0">
          ...
          {services.map((item, index) => {
            return (
              <SwiperSlide key={index}>
                <div className="bg-secondary/90 w-full h-[284px] rounded-[20px] px-[30px] py-[48px] flex flex-col
                justify-between">
