...
const Contact = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      await emailjs.send(
        "service_o305roe", // Replace with your EmailJS service ID
        "template_n15ydpd", // Replace with your EmailJS template ID
        data,
        "rEMJV0NUlJcAvvWVZ" // Replace with your EmailJS public key (user ID)
      );
